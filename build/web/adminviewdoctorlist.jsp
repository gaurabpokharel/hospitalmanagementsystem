...
<div style="float: right; margin-right: 20px">
        ...
        <h1 style="text-align: center">Doctor List</h1><hr style="width:75%; height:4px;background-color: black">  
        ...
        <table border="1" width="90%" style="text-align: center;margin-left: 5%">  
            <tr><th>Id</th><th>Full Name</th><th>User name</th>  
                <th>Email</th><th>Phone number</th><th>Department</th> <th>Delete</th></tr>  
                    <c:forEach items="${list}" var="u">  
                <tr><td>${u.getId()}</td><td>${u.getFullname()}</td><td>${u.getUsername()}</td> 
                    <td>${u.getEmail()}</td><td>${u.getPhonenumber()}</td>  
                    <td>${u.getDepartment()}</td><td><a href="deleteuser.jsp?id=${u.getId()}">Delete</a></td></tr>  
                </c:forEach>  
        </table> 
