        ...
        <div class="bottom">
            <div>
                <table border="0">
                    <tr>
                        <td width="700px">
                            <font color="#000"> Welcome to <mark> Hospital</mark> </font> <br> <br>

                            <font color="#000" size="6px"> Best Medical & Health care Needs to Our Patients </font> <br> <br>

                            A hospital is a place where a person goes to be healed when he or she is sick or injured. Doctors and nurses work at hospitals.
                            <br>
                        </td>
                ...
                <table border="0">
                    <tr>
                        <td width="700px">
                            ...
                            <font color="#000" size="6px">  Hospital & Research Center</font> <br> <br>
                            ...
                            <i class="fa fa-envelope" style="font-size:20px"></i></i> hospital@email.com
