...
<div style="float: right;margin-right: 20px">
        ...
        <form name="form" onsubmit="return validation()" method="post" action="adddepartment">

            <h2 style="text-align: center">Add New Department</h2>
            <table align="center" border="0" cellspacing="15" style="margin-left: 250px">
                <tr>
                    <td> Department Name<span class="required" style="color:red;font-size:20px;">*</span></td>
                    <td><input type="text" placeholder="Department Name" name="name" required></td>
                </tr>
