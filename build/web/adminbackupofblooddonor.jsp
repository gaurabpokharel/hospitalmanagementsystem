...
<html>
    <head>
        ...
        <title>Blood Donor Data Backup and Recovery</title>
        ...
        <form action="staffLogout">
            ...
            <div class="container">
                ...
                <div class="second-item" style="text-align: center;padding-top: 100px;font-size: 30px">
                     <table>
                    <%
                    String filename = "d:\\blooddonorbackfile.csv";
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            ...
                            fw.append(',');
                            fw.append(rs.getString("fname"));
                            fw.append(',');
                            fw.append(rs.getString("lname"));
                            fw.append(',');
                            ...
                            fw.append(',');
                            fw.append(rs.getString("dob"));
                            fw.append(',');
                            fw.append(rs.getString("bgroup"));
                           fw.append('\n');
                ...
                %>
                 ...
                 <label>Blood Donor Data Backup is successfully done</label>
                </div>
            </div>
