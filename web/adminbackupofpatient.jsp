...
<html>
    <head>
        ...
        <title>Patient Data Backup and Recovery</title>
            ...
            <div class="container">
                <div class="first-item side-bar container">
                    <div class="item">
                        ...
                        <div class="hide">
                            <div class="toggle-item cursor">-> Add new Doctor</div>
                            <div class="toggle-item cursor">-> Add new Staff</div>
                            <div class="toggle-item cursor" style="border-bottom:1px solid black;">-> Add new Department</div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="hide">
                            <div class="toggle-item cursor">-> View Doctor</div>
                            <div class="toggle-item cursor">-> View User</div>
                            <div class="toggle-item cursor" style="border-bottom:1px solid black;">-> View Staff</div>
                        </div>
                    </div>
                    <div class="item">
               ...
               <div class="item">
                ...
                <table>
<%
                    String filename = "d:\\patientbackfile.csv";
                    ...
                    try {
                        ...
                        fw.append("Patient name");
                        fw.append(',');
                        fw.append("Appointment title");
                        fw.append(',');
                        fw.append("Preferred date");
                        fw.append(',');
                        fw.append("symptoms");
                        fw.append(',');
                        fw.append("disease");
                        ...
                        fw.append(',');
                        fw.append("Allocate doctor");
                        fw.append(',');
                        fw.append("Apoointment date");
                        fw.append(',');
                        fw.append("Appointment time");
                        fw.append(',');
                        fw.append("Test");
                        fw.append(',');
                        fw.append("Deposit Amount");
                        fw.append(',');
                        fw.append("Amount");
                        fw.append(',');
                        fw.append("Medicine");
                        ...
                        while (rs.next()) {
                            fw.append(rs.getString("pname"));
                            fw.append(',');
                            fw.append(rs.getString("aptitle"));
                            fw.append(',');
                            fw.append(rs.getString("apdate"));
                            fw.append(',');
                            fw.append(rs.getString("symptoms"));
                            fw.append(',');
                            fw.append(rs.getString("disease"));
                            fw.append(',');
                            fw.append(rs.getString("email"));
                            fw.append(',');
                            fw.append(rs.getString("pnumber"));
                            fw.append(',');
                            fw.append(rs.getString("doctor"));
                            fw.append(',');
                            fw.append(rs.getString("fdate"));
                            fw.append(',');
                            fw.append(rs.getString("time"));
                            fw.append(',');
                            fw.append(rs.getString("test"));
                            fw.append(',');
                            fw.append(rs.getString("depositamount"));
                            fw.append(',');
                            fw.append(rs.getString("amount"));
                            fw.append(',');
                            fw.append(rs.getString("medicine"));
                            fw.append('\n');
                        }
                        fw.flush();
                        fw.close();
                ...
                %>
                 ...
                 <label>Patient Data Backup is successfully done</label>
                </div>
            </div>
