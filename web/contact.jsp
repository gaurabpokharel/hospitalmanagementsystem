    ...
    <body>
        ...
        <div class="contact">
            <div class="contactmail">
                <i class="fa fa-map-marker" style="font-size:30px"></i><br><br> 
                <font style="font-size:20px "> ADDRESS<font><br><br>
                Gaindakot-4,Nawalpur<br><br>
            </div>

            <div class="contactmail">
                <i class="fa fa-phone" style="font-size:30px"></i><br><br> 
                <font style="font-size:20px "> CONTACT NUMBER<font><br><br>
                +977 9800000000<br><br>
            </div>
            <div class="contactmail">
                <i class="fa fa-envelope" style="font-size:30px"></i><br><br> 
                <font style="font-size:20px "> EMAIL ADDRESS<font><br><br>
                hospital@email.com<br><br>
            </div>
        </div>

        <div style="margin-left: 30px;margin-bottom: 30px">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3532.391005959404!2d84.40429681503352!3d27.70521133219278!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3994fb6fdfd935ed%3A0x29e6424f203a7aec!2sLumbini%20ICT%20Campus!5e0!3m2!1sen!2snp!4v1589639258250!5m2!1sen!2snp" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
        <div class="nav_down">
            <div>
